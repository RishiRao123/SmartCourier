  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        if (payload.role === 'ROLE_ADMIN' || payload.role === 'ROLE_SUPER_ADMIN') {
    ...
    <div className="min-h-screen flex font-sans bg-white relative">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#071a2a] flex-col justify-center items-center relative overflow-hidden p-12">
        ...
        <div className="relative z-10 w-full max-w-lg flex flex-col items-center text-center">
          ...
          <p className="text-gray-300 text-lg mb-12 max-w-md">The most reliable delivery network in India. Sign in to manage your shipments and track in real-time.</p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="mb-10 text-center lg:text-left">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-[#071a2a] mb-3">Welcome <span className="text-yellow-500">Back</span></h2>
            <p className="text-gray-500 font-medium">Securely sign in to your courier dashboard.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <p className="text-center text-gray-500 mt-6 text-sm font-medium">
              ...
              <Link to="/signup" className="text-[#071a2a] font-black hover:text-yellow-500 transition-colors">Sign up</Link>
            </p>
          </form>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-[#071a2a]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl relative">
            ...
            <p className="text-center text-gray-500 mb-8 font-medium">
              Please enter the 6-digit OTP sent to <br/><span className="text-[#071a2a] font-black">{email}</span>
            </p>
